      ...
      if ((Math.abs(namiStat.shop[0] - x) <= 5)//캐릭터
         ...
         if (confirm("나미를 구매하시겠습니까?")) {
            ...
            if (money >= namiStat.money ) {
               ...
               $("#gold-val").html(money);
               $(".inter_illustration-img").css("background-image", "url('./images/" + namiStat.img + "1.png')");
            } else {//골드부족으로 인한 구매실패
      ...
      // 사보구매
         ...
         if (confirm("사보를 구매하시겠습니까?")) {
            ...
            if (money >= saboStat.money) {
               ...
               $("#gold-val").html(money);
               $(".inter_illustration-img").css("background-image", "url('./images/" + saboStat.img + "1.png')");
            } else {
      ...
      // 핸콕 구매
         ...
         if (confirm("핸콕을 구매하시겠습니까?")) {
            ...
            if (money >= hankokStat.money) {
               ...
               $("#gold-val").html(money);
               $(".inter_illustration-img").css("background-image", "url('./images/" + hankokStat.img + "1.png')");
            } else {
         ...
         if (confirm("상디를 구매하시겠습니까?")) {
            ...
            if (money >= sangdiStat.money) {
               ...
               $("#gold-val").html(money);
               $(".inter_illustration-img").css("background-image", "url('./images/" + sangdiStat.img + "1.png')");
            } else {
      ...
      //에이스 구매
         ...
         if (confirm("에이스를 구매하시겠습니까?")) {
            ...
            if (money >= aceStat.money) {
               ...
               $("#gold-val").html(money);
               $(".inter_illustration-img").css("background-image", "url('./images/" + aceStat.img + "1.png')");
            } else {
         ...
         if (confirm("루피를 구매하시겠습니까?")) {
            ...
            if (money >= ruffyStat.money) {
               ...
               $("#gold-val").html(money);
               $(".inter_illustration-img").css("background-image", "url('./images/" + ruffyStat.img + "1.png')");
            } else {
         ...
         if (confirm("조로를 구매하시겠습니까?")) {
            ...
            if (money >= joroStat.money) {
               ...
               $("#gold-val").html(money);
               $(".inter_illustration-img").css("background-image", "url('./images/" + joroStat.img + "1.png')");
            } else {
      ...
      //샹크스 구매
         ...
         if (confirm("샹크스를 구매하시겠습니까?")) {
            ...
            if (money >= shanksStat.money) {
               ...
               $("#gold-val").html(money);
               $(".inter_illustration-img").css("background-image", "url('./images/" + shanksStat.img + "1.png')");
            } else {
         ...
         if (confirm("미호크를 구매하시겠습니까?")) {
            ...
            if (money >= mihawkStat.money) {
               ...
               $("#gold-val").html(money);
               $(".inter_illustration-img").css("background-image", "url('./images/" + mihawkStat.img + "1.png')");
            } else {
...
function stopMoveSprite() {
   ...
   if (direct == 0) {
      ...
      $(".box").css("background-image", "url('./images/" + nowChar.img + "_L_move.png')");
   } else if (direct == 1) {
...
function moveSprite() {
   ...
   if (direct == 0) {
	   ...
	   $(".box").css("background-image",
			   "url('./images/" + nowChar.img + "_L_move.png')");
   } else if (direct == 1) {
...
function attack() {
   ...
   if (direct == 0) {
      ...
      $(".box").css("background-position-y", imgY_L + "px");
      $(".box").css("background-image", "url('./images/" + nowChar.img + "_L_attack.png')");
      ...
      $(".box").css("background-position-x", imgX + "px");
      $(".box").css("background-position-y", imgY + "px");
      $(".box").css("background-image", "url('./images/" + nowChar.img + "_R_attack.png')");
